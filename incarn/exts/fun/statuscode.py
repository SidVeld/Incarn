...
from discord.ext.commands import group, Context, Cog
...
class HTTPStatusCodes(Cog):
    ...
    async def http_status_group(self, ctx: Context, code: int) -> None:
    ...
    async def build_embed(self, url: str, ctx: Context, code: int) -> None:
