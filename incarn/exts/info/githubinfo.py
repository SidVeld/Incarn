...
from discord.ext.commands import group, cooldown, Context, Cog

from incarn.bot import IncarnBot
from incarn.constants import Colours, NEGATIVE_REPLIES
...
class GithubInfo(Cog):
    ...
    @group(name="github", aliases=("gh", "git"))
