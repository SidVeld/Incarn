...
import incarn
from incarn.constants import Emojis, MODERATION_ROLES, NEGATIVE_REPLIES
...
async def wait_for_deletion(
    ...
    try:
        try:
            await incarn.instance.wait_for('reaction_add', check=check, timeout=timeout)
